...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        otpEditText = findViewById(R.id.otpNum);
        phoneBtn = findViewById(R.id.nextBtn);
        verifyBtn = findViewById(R.id.otpNextBtn);
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                LinearLayout layout = findViewById(R.id.numLayout);
...
//                            FirebaseUser user = task.getResult().getUser();
                            ...
                            Toast.makeText(getApplicationContext(),"Failed! Try Again." +
